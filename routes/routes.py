...
from utils.utility import fetch_data, check_user_subscription, generate_menu, get_products, handle_stripe_operations, get_country_code, clean_phone_number, validate_incomming_message, save_sms_history, load_sms_history, build_system_prompt, process_questions_answers, build_and_send_messages, send_reply, build_and_send_messages_openai, update_billing_info, format_phone_number, handle_payment_success, handle_billing_issue, handle_subscription_cancellation, send_end_subscription_email, save_user_and_assistant_preferences, send_new_subscription_communications, get_location‎
import stripe
import aiohttp
import asyncio
import openai
